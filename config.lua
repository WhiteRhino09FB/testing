...
Config.OpenStash = function(uniqueID, storagekg, carriage)
    if Config.Inventory == "ch" then
        TriggerEvent(
            "inventory:openHouse",
            "Train:" .. uniqueID .. "-carriage:" .. carriage,
            "Train:" .. uniqueID .. "-carriage:" .. carriage,
            "",
            storagekg
        )
...
Config.Trains = {
	...
	[4] = {
        trainindex = 6,
        label = "Cargo Train - 2 Freight 1 Open 1 Tanker",
        storage = 30000,
        price = 1,
        maxSpeed = 27 -- * 3.70 for the real vitesse (27 * 3.70 = 100km/h)
    },
...
Config.Stations = {
    [1] = {
        ...
        coordspnj = vector4(651.38629150391,-801.87567138672,23.264513015747, 263.6),
        coordsdeletetrain = vector3(666.89562988281,-811.05810546875,23.476922988892),
        path = {
            [1] = vector3(664.29669189453,-818.68939208984,23.382720947266),
            [2] = vector3(669.63568115234,-801.61755371094,23.429964065552)
        }
    },
    [2] = {
        label = "Harbor Station",
        pedmodel = "g_m_m_armgoon_01",
        coordspnj = vector4(151.58073425293,-2059.8823242188,18.321676254272, 102.0),
        coordsspawn = vector3(146.95468139648,-2052.0563964844,18.321655273438),
        coordsdeletetrain = vector3(146.666015625,-2059.4279785156,18.321649551392),
        path = {
            [1] = vector3(147.93426513672,-2032.2436523438,18.321653366089)
        }
    },
    [3] = {
...
Config.TrainShop = {
    ["Stock"] = {
        pedmodel = "g_m_m_armgoon_01",
        coordspnj = vector4(656.72595214844,-782.97003173828,24.549482345581, 198.4),
        traintobuy = {19, 20, 27, 6, 18},
        job = "traindriver" -- Remove this line if none
    },
    ["SubWayStock"] = {
        metrostation = true,
        pedmodel = "g_m_m_armgoon_01",
...
Config.Lang = {
    ...
    ["GetOutTrain"] = "Took out the train : %s",
	...
	["OpenStash"] = "Open the train storage",
    ["OpenShopOxTarget"] = "Open the train shop",
    ["StowTrain"] = "Flex E to Garage your train at station",
